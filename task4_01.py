...
'''
100 loops, best of 5: 88.7 usec per loop    -   10
100 loops, best of 5: 820 usec per loop     -   100
...
раз чем во втором алгоритме. Но на практике видим, что эта разница минимальная. Даже алгоритм использующий встроенные
методы работы со списками работают, немного но быстрее. Видимо встроенные методы очень хорошо оптимизированы.
